...
nnoremap <silent> <Leader>fb :DashboardJumpMark<CR>d
...
augroup mygroup
  autocmd!
  " Setup formntexpr specified filetype(s).
...
" Example: `<leader>aap` for current paragraphS
